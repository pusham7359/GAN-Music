# -*- coding: utf-8 -*-
"""
Created on Fri Sep 14 16:53:10 2018
...
for e in range(num_epoch):
    for i in range(numBatches):
        ...
        y_eval_real,  y_eval_fake  = np.ones([16, 1]), np.zeros([16, 1])
    ...
    # evaluate
    X_eval_real = X_test_real[np.random.choice(len(X_test_real), 16, replace=False)]
